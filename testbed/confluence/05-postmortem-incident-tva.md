...
- J1 : écart signalé par la comptabilité (export CSV, XRAGSAND-3).
...
- J3 : correctif temporaire ; la refonte complète du calcul est suivie par
  **XRAGSAND-2** (MR « Refonte du calcul de TVA » ouverte sur fake-billing).

## Actions

- [x] Correctif temporaire en production.
- [ ] Refonte du calculateur (XRAGSAND-2).
